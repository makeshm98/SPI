...
void loop() {
    ...
    writeRegister(0x64, 0b01011001); //100ms for heating duration
    writeRegister(0x5A, 0b00100100); //assigning target heater resistance value for gas sensor hot plate to register 0x5A
    writeRegister(0x71, 0b00101001); //previously defined heater settings and run gas measurements 
    writeRegister(0x70, 0b00000000); //heater off
